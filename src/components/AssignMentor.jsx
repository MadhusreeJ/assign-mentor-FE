...
const AssignMentor = () => {
  const navigate = useNavigate();
    ...
    let getData = async () => {
        try {
          const unassignedStudents = await axios.get("https://assign-mentor-be-lga4.onrender.com/unassignedstudents");
  ...
  let onsubmit = async(event)=>{
    ...
    try {
       await axios.put(`https://assign-mentor-be-lga4.onrender.com/assignmentor/${selectedMentor}/students`,students);
       navigate("/");
      } catch(error){
             console.log(error);
      }
